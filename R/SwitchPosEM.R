                          ...
                          penalty, hyper.params.kj)
{
  ...
  switch (comp.kj.dist,
          ...
          "poisson"     = {temp = EMMPoisson(params.old = comp.kj.params.old,
                                                         tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                         expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                         z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                         penalty = penalty, hyper.params = hyper.params.kj) },
          "ZI-poisson"  = {temp = EMMPoisson(params.old = comp.kj.params.old,
                                                         tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                         expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                         z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                         penalty = penalty, hyper.params = hyper.params.kj) },
          "nbinom"      = {temp = EMMNegativeBinomial(params.old = comp.kj.params.old,
                                                        tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                        expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                        z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                        penalty = penalty, hyper.params = hyper.params.kj) },
          "ZI-nbinom"   = {temp = EMMNegativeBinomial(params.old = comp.kj.params.old,
                                                        tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                        expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                        z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                        penalty = penalty, hyper.params = hyper.params.kj) },
          "binom"       = {temp = EMMBinomial(params.old = comp.kj.params.old,
                                                       tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                       expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                       z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                       penalty = penalty, hyper.params = hyper.params.kj) },
          "ZI-binom"    = {temp = EMMBinomial(params.old = comp.kj.params.old,
                                                       tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                       expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                       z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                       penalty = penalty, hyper.params = hyper.params.kj) },
          "gammacount"  = {temp = EMMGammaCount(params.old = comp.kj.params.old,
                                                            tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                            expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                            z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                            penalty = penalty, hyper.params = hyper.params.kj) },
          "ZI-gammacount"  = {temp = EMMGammaCount(params.old = comp.kj.params.old,
                                                               tl = tl.k, yl = yl.k, yu = yu.k, tu = tu.k,
                                                               expert.ll = comp.kj.pos.expert.ll, expert.tn = comp.kj.pos.expert.tn, expert.tn.bar = comp.kj.pos.expert.tn.bar,
                                                               z.e.obs = z.e.obs, z.e.lat = z.e.lat, k.e = k.e,
                                                               penalty = penalty, hyper.params = hyper.params.kj) },
