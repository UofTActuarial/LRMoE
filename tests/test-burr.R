...
#                    nrow = 1, byrow = T)
#
# # params.list = list(list(c(2, 1, 10), c(3, 2, 15)))
#
# params.list = list(list(c(4, 3, 10), c(3, 2, 15)))
#
...
#                    nrow = 1, byrow = T)
#
# params.init = list(list(c(3, 2, 8), c(4, 2, 10)))
#
# params.init = list(list(c(5, 2, 8), c(2, 2, 10)))
#
...
# head(Y)
#
# params.init = list(list(c(5, 3, 8), c(6, 1, 10)))
#
# params.list = list(list(c(4, 3, 10), c(3, 2, 15)))
#
#
# model.fit = LRMoEFit(Y, X, 2, comp.dist, alpha.init, zero.init, params.init, print = T, eps = 0.05)
