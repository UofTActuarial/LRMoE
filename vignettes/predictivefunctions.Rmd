---
title: "Predictive Functions in LRMoE"
description: >
  Using the LRMoE model to make predictions.
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Predictive Functions in LRMoE}
...
Throughout this page, `Y` is a matrix of response, `X` a matrix of covariates, `alpha` a matrix of logit regression coefficients and `model` a matrix of expert functions.
